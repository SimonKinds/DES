...
uint64_t initial_permutation(const uint64_t* message) {
  ...
  permutate((uint8_t*)message, BLOCK_SIZE, (uint8_t*)&permutated, BLOCK_SIZE,
            IP_PERMUTATION_ARRAY);
  return permutated;
}

uint64_t inverse_initial_permutation(const uint64_t* data) {
  uint64_t permutated = 0;
  permutate((uint8_t*)data, BLOCK_SIZE, (uint8_t*)&permutated, BLOCK_SIZE,
            INVERSE_IP_PERMUTATION_ARRAY);
  return permutated;
}

uint64_t key_permutation_first(const uint64_t* key) {
  uint64_t permutated = 0;
  permutate((uint8_t*)key, BLOCK_SIZE, (uint8_t*)&permutated,
...
uint64_t expansion_permutation(const uint32_t* r) {
  uint64_t permutated = 0;
  permutate((uint8_t*)r, BLOCK_SIZE / 2, (uint8_t*)&permutated,
...
uint32_t p_permutation(const uint32_t* data) {
  ...
  permutate((uint8_t*)data, BLOCK_SIZE / 2, (uint8_t*)&permutated,
            BLOCK_SIZE / 2, P);
  return permutated;
}
...
uint32_t calculate_r(const uint32_t prev_l, const uint32_t prev_r,
                     const uint64_t* key) {
